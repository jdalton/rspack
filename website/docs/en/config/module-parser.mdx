...
### javascript.importMetaContext

- **Type:** `boolean`
- **Default:** `true`

Control whether Rspack parses `import.meta.webpackContext()` calls. When both `javascript.importMeta.webpackContext` and `javascript.importMetaContext` are configured, `javascript.importMeta.webpackContext` has higher priority.
